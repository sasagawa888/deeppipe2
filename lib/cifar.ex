defmodule CIFAR do
  ...
  # for CNN test
  # CIFAR.adagrad(400,500) 20epochs mini batch size 400

  defnetwork init_network1(_x) do
    _x
    |> f(3, 3, 3, 8, {1, 1}, 1, 0.2, 0.01)
    |> relu
    |> f(3, 3, 8, 8, {1, 1}, 1, 0.2, 0.01)
    |> pooling(2, 2)
    |> f(3, 3, 8, 16, {1, 1}, 1, 0.2, 0.01)
    |> relu
    |> f(3, 3, 16, 16, {1, 1}, 1, 0.2, 0.01)
    |> relu
    |> pooling(2, 2)
    # |> analizer(1)
    |> f(3, 3, 16, 32, {1, 1}, 0, 0.2, 0.01)
    |> f(3, 3, 32, 32, {1, 1}, 0, 0.2, 0.01)
    |> f(3, 3, 32, 32, {1, 1}, 0, 0.2, 0.00)
    # |> analizer(2)
    |> full
    |> w(128, 10, 0.2, 0.01)
    |> b(10, 0.2, 0.01)
